...
// // Build permissions matrix for each role based on PERMISSIONS
...
// // Normalize roles coming from backend into a consistent shape
// function normalizeBackendRoles(backendRoles) {
...
// // Helper to merge / normalize perms for a single role
...
//   const setMainTab = (tabKey) => setSearchParams({ tab: tabKey });
...
//         } else {
//           setRolePermissions(buildPermissionsMatrix(rolesFromBackend));
//         }
//       } catch (err) {
//         console.error(err);
