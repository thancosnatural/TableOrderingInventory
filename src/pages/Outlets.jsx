...
import CompanySelectFilter from "@/components/PageSections/PageCompanySelectionFilter";
...
export default function BranchesPage() {
  ...
  const stateOptions = useMemo(
    () => ["All", "Karnataka", "Tamil Nadu", "Kerala", "Telangana", "Andhra Pradesh"],
    []
  );
    ...
    <PageShell>
      ...
      {isSuperAdmin ? (
        <CompanySelectFilter
          ...
          helperText="Select a company to view/manage its outlets."
        />
      ) : null}
      ...
      <div className="bg-white border rounded-lg p-4">
              ...
              <ResponsiveDataTable
                    ...
                    render: (b) => (
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-gray-500">{b?.city ?? b?.location ?? ""}</div>
                        </div>
                      </div>
                    ),
                  },
                  ...
                  },
                  {
                    ...
                    render: (b) => (
                      <div className="text-center">
                        <div className={`mt-1 text-xs ${b?.is_active ? "text-green-500" : "text-gray-500"}`}>
                ...
                actions={(branch) => [
                  ...
                  { key: "edit", label: "Edit", onClick: () => openEdit(branch) },
                  {
                    ...
                    confirmDescription: "This action will permanently remove the outlet. This cannot be undone.",
                    confirmLabel: "Delete",
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-gray-500">{branch?.city ?? branch?.location ?? "—"}</div>

                          {/* ✅ fixed prop name */}
                          <div className="mt-1">
                            <ActiveStatus active={Boolean(branch?.is_active)} />
                          </div>
                        </div>
                      </div>
        ...
        {/* ✅ if your Pagination expects onChange */}
        <Pagination
