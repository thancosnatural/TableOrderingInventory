...
export function AuthProvider({ children, baseUrl = '/' }) {
  const [user, setUser] = useState({name:"Bharath Admin", role:"super_admin", email:"bk3604073@gmail.com"});
  ...
  return (
    <AuthContext.Provider value={{ api, user, accessToken, login, logout, refreshToken, loadingAuth, setUser, setAccessToken, role:"super_admin" }}>
      {children}
